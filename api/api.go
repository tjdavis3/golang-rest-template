//go:generate go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen --old-config-style --package=api --generate types,chi-server,spec --exclude-schemas=ErrResponse -o api.gen.go ../spec/openapi.yaml
